...
;Test case
;(define (f x) (call cons x 1)) ; Very Important "call cons", never missing the call in cons
;(call f 2) 

;Pay attention to the eval-helper function. You will understand the scope rule of  Scheme